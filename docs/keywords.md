...
The preserved Python keywords are:
...
* [`final`](names.md#final-local-variables)
* [`_`](names.md#black-hole-assignment-with-_)
* [`let`](destructuring.md)
* [`type`](types.md#type-aliases)
* [`trust`](casting.md)
...
* [`trait`](traits.md)
* [`override`](traits.md#explicit-overrides)
* [`implement`](traits.md#implementing-a-trait-after-the-fact)
* [`getter`](classes.md#no-property)
* [`setter`](classes.md#no-property)
...
* [`factory`](construction.md#factory-construction)
