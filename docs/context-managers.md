...
[Modern type specification](type-specification.md) describes for
...
[Explicit overrides](traits.md)'s `override` already does, rather
...
reason `__len__` is (see [Numeric types](numeric-types.md)'s
